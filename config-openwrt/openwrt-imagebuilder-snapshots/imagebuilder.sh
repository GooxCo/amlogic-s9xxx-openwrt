...
custom_files_path="${make_path}/config-openwrt/openwrt-imagebuilder-snapshots/files"
custom_config_file="${make_path}/config-openwrt/openwrt-imagebuilder-snapshots/config"
...
download_imagebuilder() {
    ...
    download_file="https://downloads.openwrt.org/${rebuild_branch}/targets/armvirt/64/openwrt-imagebuilder-armvirt-64.Linux-x86_64.tar.xz"
...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        f2fs-tools f2fsck fdisk getopt git-http gzip hostapd hostapd-common hostapd-utils iconv iw iwinfo jq jshn \
