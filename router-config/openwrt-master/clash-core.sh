...
# wget --show-progress -qO- $clash_dreamacro | gunzip -c > $COREDIR/clash
# wget --show-progress -qO- $clash_tun_dreamacro | gunzip -c > $COREDIR/clash_tun
...
# wget --show-progress -qO- $clash_tun_meta | gunzip -c > $COREDIR/clash_tun_meta
...
mkdir -p $YACD
wget --show-progress -qO $YACD/Tutorials.svg https://img.shields.io/badge/Tutorials--lightgrey?logo=Wikipedia&style=social
wget --show-progress -qO $YACD/Star.svg https://img.shields.io/badge/Star--lightgrey?logo=github&style=social
wget --show-progress -qO $YACD/Telegram.svg https://img.shields.io/badge/Telegram--lightgrey?logo=Telegram&style=social
wget --show-progress -qO $YACD/Sponsor.svg https://img.shields.io/badge/Sponsor--lightgrey?logo=ko-fi&style=social
