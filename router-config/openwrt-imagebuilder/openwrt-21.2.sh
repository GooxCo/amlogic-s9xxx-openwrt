...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        luci-proto-ipv6 luci-proto-openconnect luci-proto-ppp luci-proto-qmi luci-proto-relay luci-ssl \
        \
        luci-theme-material \
        \
        ...
        php7 php7-cgi php7-mod-session php7-mod-ctype php7-mod-fileinfo php7-mod-zip php7-mod-iconv php7-mod-mbstring \
        \
        ...
        \
        iptables-mod-tproxy iptables-mod-extra libcap-bin ip6tables-mod-nat ruby ruby-yaml libnetfilter-conntrack3 \
        ip-full kmod-tun libnettle8 \
        "
