...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        f2fs-tools f2fsck fdisk getopt git git-http gzip hostapd-utils hostapd-common iconv iw iwinfo jq jshn  \
        ...
        uuidgen wget-ssl wpa-cli wpad-basic wwan xfs-fsck xfs-mkfs xz  \
